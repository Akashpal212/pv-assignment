    ...
    return(
        ...
        <div className="w-full bg-slate-900 text-center items-center py-5 px-3">
            <h1 className=" text-white font-semibold text-sm tab:text-[20px] md:text-[16px]">
                Created By <span className="text-[#FF731D]"><a target="_blank" href="https://www.linkedin.com/in/akash-pal-0b43b0260/">Akash Pal</a></span> | ©️ 2024 All rights reserved.</h1>
        </div>
        </>
    )
}
